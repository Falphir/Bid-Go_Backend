    ...
    public TransportUpdateStatusServiceTests()
  {
   ...
   return new ClaimsPrincipal(new ClaimsIdentity(claims, "mock"));
    ...
    private static TransportRequest MakeRequest(ERequestStatus status, List<Bid>? bids = null)
    {
     ...
     private static Company MakeCompany(int id =100) => 
            new Company { Id = id, Name = "Co", Email = "c@x.com", Password = "p", PhoneNumber =123456789, CompanyName = "C1", Address = "A" };
    private static Driver MakeDriver(int id =200) 
            => new Driver { Id = id, Name = "Dr", Email = "d@x.com", Password = "p", PhoneNumber =123456789, DriverLicense = "DL", Insurance = "IN" };
