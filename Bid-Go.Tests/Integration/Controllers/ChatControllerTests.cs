...
namespace Bid_Go.Tests.Integration.Controllers
{
 ...
 {
 var company = new Company { Name = "C", CompanyName = "CC", Address = "A", Email = "c@c.com", Password = "x", PhoneNumber =900000000, NIF =111111111 };
 var driver = new Driver { Name = "D", Email = "d@x.com", Password = "x", PhoneNumber =911111111, NIF =123456789 };
 ...
 db.SaveChanges();
 var acceptedBid = new Bid { TransportRequestId = tr.TransportRequestId, DriverId = driver.Id, Status = EBidStatus.Accepted, Value =50, DeliveryDeadline = DateTime.UtcNow.AddDays(1) };
