...
namespace Bid_Go.Tests.Integration.Controllers
{
 ...
 new TransportRequest { CompanyId =5, Status = ERequestStatus.Draft, Origin = "O", Destination = "D", Package = "P", Weight =1, Volume =1, Length =1, Width =1, Height =1, PickupDate = DateTime.UtcNow.AddDays(3), DeliveryDate = DateTime.UtcNow.AddDays(5), BiddingStartDate = DateTime.UtcNow, BiddingEndDate = DateTime.UtcNow.AddDays(1), Image = "x.png", MaxPrice =50 },
 new TransportRequest { CompanyId =5, Status = ERequestStatus.Active, Origin = "O2", Destination = "D2", Package = "P2", Weight =2, Volume =2, Length =2, Width =2, Height =2, PickupDate = DateTime.UtcNow.AddDays(4), DeliveryDate = DateTime.UtcNow.AddDays(6), BiddingStartDate = DateTime.UtcNow, BiddingEndDate = DateTime.UtcNow.AddDays(2), Image = "y.png", MaxPrice =100 }
 );
 await db.SaveChangesAsync();
