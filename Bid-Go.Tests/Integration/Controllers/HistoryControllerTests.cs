...
namespace Bid_Go.Tests.Integration.Controllers
{
 ...
 {
 var company = new Company { Name = "Comp", CompanyName = "Comp Lda", Address = "Addr", Email = "c@x.com", Password = "x", PhoneNumber =900000000, NIF =111111111 };
 var driver = new Driver { Name = "Driver X", Email = "d@x.com", Password = "x", PhoneNumber =911111111, NIF =222222222 };
 ...
 var b1 = new Bid { TransportRequestId = tr1.TransportRequestId, DriverId = driver.Id, Value =50, DeliveryDeadline = DateTime.UtcNow.AddDays(-3), Status = EBidStatus.Accepted };
 var b2 = new Bid { TransportRequestId = tr2.TransportRequestId, DriverId = driver.Id, Value =150, DeliveryDeadline = DateTime.UtcNow.AddDays(-1), Status = EBidStatus.Rejected };
 ...
 {
 var company = new Company { Name = "Comp2", CompanyName = "Comp2 Lda", Address = "Addr2", Email = "c2@x.com", Password = "x", PhoneNumber =900000001, NIF =111111112 };
 var driver = new Driver { Name = "D2", Email = "d2@x.com", Password = "x", PhoneNumber =922222222, NIF =333333333 };
 db.Companies.Add(company);
 db.Drivers.Add(driver);
 db.SaveChanges();
 ...
 var accepted = new Bid { TransportRequestId = tr1.TransportRequestId, DriverId = driver.Id, Value =70, DeliveryDeadline = DateTime.UtcNow.AddDays(-3), Status = EBidStatus.Accepted };
