...
{
 /// <summary>
 /// Service for profile retrieval and update operations for drivers and companies.
 /// </summary>
 ...
 /// <summary>
 /// Get a user profile by id or null if not found. Throws if inactive.
 /// </summary>
 ...
 /// <summary>
 /// Update driver profile fields and upload new documents if provided.
 /// </summary>
 ...
 // Upload new driver license image if provided
 ...
 /// <summary>
 /// Deactivate a user if there are no blocking active resources (bids or requests).
 /// </summary>
